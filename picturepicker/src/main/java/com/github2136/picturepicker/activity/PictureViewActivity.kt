 ...
 */
class PictureViewActivity : AppCompatActivity(), PhotoFragment.OnFragmentInteractionListener {
    ...
    private val mOnClickListener = View.OnClickListener {
        ...
        if (mPickerPaths!!.contains(currentPath)) {
            ...
            if (mPickerCount > mPickerPaths!!.size) {
                ...
                Toast.makeText(this@PictureViewActivity, "最多选择 $mPickerCount 张", Toast.LENGTH_SHORT).show()
            }
        }
        setBottom()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mPhotoPaths = intent.getStringArrayListExtra(ARG_PICTURES)
